...
#
# NOTE: Set DATABASE_URL as an environment variable on Render.
# For PostgreSQL, Render may provide a URL like "postgres://...".
# SQLAlchemy with psycopg requires "postgresql+psycopg://".
# This code will convert it automatically if needed.
#
...
# --- Run ---
# No Flask-Migrate or migration commands; tables are created automatically.
